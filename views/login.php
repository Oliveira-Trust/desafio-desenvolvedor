        ...
        <div class="row h-100">
            ...
            <div class="col-md-6 my-auto">
                <form id="formLoginUser">
                    ...
                    <input type="email" name="email" id="email" class="form-control" placeholder="Seu endereço de email" required autofocus>
                    <label for="password" class="sr-only">Senha</label>
                    <input type="password" name="password" id="password" class="form-control" placeholder="Sua senha" required>
                    <button class="btn btn-lg btn-primary btn-block mt-3" type="button" onclick="new Login().loginUser()">Fazer login</button>
