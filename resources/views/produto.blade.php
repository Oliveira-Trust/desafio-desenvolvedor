 ...
 <div class="ibox-content">
     <div class="table-responsive">
         <table id="tabProduto" class="table table-striped table-bordered table-hover">
             <thead>
                 <tr>
 ...
 <script>
     $(document).ready(function() {
             ...
             buttons: [{
                 ...
                 },
                 {
                     ...
                     action: function(e, dt, node, config) {
                         ...
                         sessionStorage.setItem("produto_dados", JSON.stringify('null'));
         ...
         $('#tabProduto tbody').on('click', 'button', function() {
             var data = $('#tabProduto').DataTable().row($(this).parents('tr')).data();
             ajax_grid_produto(data);

         });
         $('#tabProduto tbody').on('click', 'tr', function() {
             $(this).toggleClass('selected');
             $('#tabProduto').DataTable().rows('.selected').data();
