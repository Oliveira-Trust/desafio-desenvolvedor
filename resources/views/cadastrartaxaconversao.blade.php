            ...
            <div class="offset-3 col-6">
                ...
                <div class="card mt-5">
                    <div class="card-header bg-success text-white">
                        <b>Cadastrar taxa de conversão</b>
                    </div>
                    <div class="card-body">

                        <form id="frmtaxaconversao" name="frmtaxaconversao" action="">
                        
                            <label for="valorReferencia">Valor de Referência:</label>
                            <input class="form-control mb-3" type="text" id="valorReferencia"
                                name="valorReferencia" required />

                            <label for="taxaMaior">Taxa Maior:</label>
                            <input class="form-control mb-3" type="text" id="taxaMaior" name="taxaMaior" required/>

                            <label for="taxaMenor">Taxa Menor:</label>
                            <input class="form-control mb-3" type="text" id="taxaMenor" name="taxaMenor" required />


                            <button class="btn btn-success mb-3" id="enviar" name="enviar" type="submit"
                                onclick="cadastrarTaxaConversao()">Cadastrar</button><br>
                        </form>
