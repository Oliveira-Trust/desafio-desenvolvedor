<nav x-data="{ open: false }" class="border-b border-gray-100 bg-white dark:border-gray-700 dark:bg-gray-800">
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 justify-between">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('app.converter')" :active="request()->routeIs('app.converter')">
                        {{ __('Conversor') }}
                    </x-nav-link>
                </div>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="space-y-1 pb-3 pt-2">
            <x-responsive-nav-link :href="route('app.converter')" :active="request()->routeIs('app.converter')">
                {{ __('Conversor') }}
            </x-responsive-nav-link>
        </div>
        @if (auth()->user()->isAdmin())
