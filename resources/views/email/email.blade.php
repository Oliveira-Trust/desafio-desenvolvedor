...
<head>
    ...
    <style type="text/css">
        ...
        /*** BMEMBF END ***/
        table[name="bmeMainBody"], body {background-color:#fff;}
...
<table width="100%" cellspacing="0" cellpadding="0" border="0" name="bmeMainBody" style="background-color: rgb(225, 225, 225);" bgcolor="#57248e">
    <tbody>
    <tr>
            ...
            <table cellspacing="0" cellpadding="0" border="0" name="bmeMainColumnParentTable" style="border-collapse: separate; border-spacing: 0px;" width="100%">
                ...
                <tr>
                    <td name="bmeMainColumnParent" style="border: 0px none transparent; border-radius: 0px; border-collapse: separate; border-spacing: 0px; overflow: visible;">
                        <table name="bmeMainColumn" class="bmeMainColumn" style="max-width: 100%; border-radius: 0px; border-collapse: separate; border-spacing: 0px; overflow: visible;" cellspacing="0" cellpadding="0" border="0" align="center" width="100%">
                            <tbody>
                            <tr>
                            ...
                            <tr>
                                <td width="100%" class="bmeHolder" valign="top" align="center" name="bmeMainContentParent" style="border: 0px none transparent; border-radius: 0px; border-collapse: separate; border-spacing: 0px; overflow: hidden;">
                                    <table name="bmeMainContent" style="border-radius: 0px; border-collapse: separate; border-spacing: 0px; border: 0px none transparent; overflow: visible;" width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                        <tbody>
                                        <tr>
                                            <td width="100%" class="blk_container bmeHolder" name="bmeHeader" valign="top" align="center" style="color: rgb(56, 56, 56); border: 0px none transparent; background-color: rgb(225, 225, 225);" bgcolor="#57248e">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                                    <tbody>
                                                                    <tr>
                                                                        <td align="left" class="bmeImage" style="border-collapse: collapse; padding: 20px;"><img
                                                                                src="https://www.uqbar.com.br/wp-content/uploads/2020/02/logo-1.png" width="255" style="max-width: 255px; display: block; width: 255px;" alt="" border="0" imgid="imgkp8dl9f5HXrf"></td>
                                                                    </tr>
                                                                    </tbody>
                                                                </table>
                                                            </td>
                                                ...
                                                <div id="dv_25" class="blk_wrapper">
                                                    <table width="600" cellspacing="0" cellpadding="0" border="0" class="blk" name="blk_divider" style="">
                                                        <tbody>
                                                        <tr>
                                                            <td class="tblCellMain" style="padding: 10px 0px 40px;">
                                                                <table class="tblLine" cellspacing="0" cellpadding="0" border="0" width="100%" style="border-top-width: 1px; border-top-color: rgb(189, 154, 211); border-top-style: dotted; min-width: 1px;">
                                                                    <tbody>
                                                                    <tr>
                                                                        <td><span></span></td>
                                                                    </tr>
                                                ...
                                                <div id="dv_1" class="blk_wrapper">
                                                    <table width="600" cellspacing="0" cellpadding="0" border="0" class="blk" name="blk_imagecaption" style="">
                                                        <tbody>
                                                        <tr>
                                                            <td>
                                                                            ...
                                                                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                                                ...
                                                                                <tr>
                                                                                    <td class="tdPart" valign="top">
                                                                                        <table cellspacing="0" cellpadding="0" border="0" class="bmeImageContainer" width="560" align="left" style="float:left;">
                                                                                            <tbody>
                                                                                            <tr>
                                                                                                <td valign="top" name="tdContainer">
                                                                                                    <table cellspacing="0" cellpadding="0" border="0" class="bmeImageTable" dimension="30%" imgid="1" style="float: right;" align="right" width="177" height="264">
                                                                                                        <tbody>
                                                                                                        <tr>
                                                                                                            <td name="bmeImgHolder" width="187" align="center" valign="top" class="bmeMblCenter" height="264"><img
                                                                                                                    src="https://images.vexels.com/media/users/3/145442/isolated/lists/c4fe889ee4828391ca985f831f8c0b80-mao-segurando-um-saco-de-dinheiro.png" class="mobile-img-large" width="177" style="max-width: 360px; display: block;" imgid="imgkp8dl9f5HXrf" border="0"></td>
                                                                                                        </tr>
                                                                                                        </tbody>
                                                                                                    </table>
                                                                                                    <table cellspacing="0" cellpadding="0" border="0" class="bmeCaptionTable" style="float:left;" align="left" width="363">
                                                                                                        <tbody>
                                                                                                        <tr>
                                                                                                            <td name="tblCell" valign="top" align="left" style="font-family: Arial,Helvetica,sans-serif; font-size: 14px; font-weight: normal; color: #383838; text-align: left;" class="bmeMblCenter tblCell">
                                                                                                                <div style="line-height: 150%;"><span style="font-size: 30px; font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Helvetica, Arial, sans-serif; color: #4f4f4f; line-height: 150%;"><strong>Conversão de Moeda</strong></span>
                                                                                                                    <br>
                                                                                                                    <br><span style="font-size: 14px; font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Helvetica, Arial, sans-serif; color: #4f4f4f; line-height: 150%;"><b>Moeda de origem:</b>  {{ $data['currency_origin'] }}</span>
                                                                                                                    <br>
                                                                                                                    <br><span style="font-size: 14px; font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Helvetica, Arial, sans-serif; color: #4f4f4f; line-height: 150%;"><b>Moeda de destino:</b>  {{ $data['currency_destiny'] }}</span>
                                                                                                                    <br>
                                                                                                                    <br><span style="font-size: 14px; font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Helvetica, Arial, sans-serif; color: #4f4f4f; line-height: 150%;"><b>Valor para conversão:</b> $ {{ $data['value_conversion'] }}</span>
                                                                                                                    <br>
                                                                                                                    <br><span style="font-size: 14px; font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Helvetica, Arial, sans-serif; color: #4f4f4f; line-height: 150%;"><b>Forma de pagamento:</b>  {{ $data['form_payment'] }}</span>
                                                                                                                    <br>
                                                                                                                    <br><span style="font-size: 14px; font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Helvetica, Arial, sans-serif; color: #4f4f4f; line-height: 150%;"><b>Valor da "Moeda de destino" usado para conversão:</b> $ {{ $data['value_curreny'] }}</span>
                                                                                                                    <br>
                                                                                                                    <br><span style="font-size: 14px; font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Helvetica, Arial, sans-serif; color: #4f4f4f; line-height: 150%;"><b>Valor comprado em "Moeda de destino":</b> $ {{ $data['bidden'] }}</span>
                                                                                                                    <br>
                                                                                                                    <br><span style="font-size: 14px; font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Helvetica, Arial, sans-serif; color: #4f4f4f; line-height: 150%;"><b>Taxa de pagamento:</b> R$ {{ $data['tax_payment'] }}</span>
                                                                                                                    <br>
                                                                                                                    <br><span style="font-size: 14px; font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Helvetica, Arial, sans-serif; color: #4f4f4f; line-height: 150%;"><b>Taxa de conversão:</b> R$ {{ $data['tax_conversion'] }}</span>
                                                                                                                    <br>
                                                                                                                    <br><span style="font-size: 14px; font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Helvetica, Arial, sans-serif; color: #4f4f4f; line-height: 150%;"><b>Valor utilizado para conversão descontando as taxas:</b> R$ {{ $data['value_without_tax'] }}</span>
                                                                                                                    <br>
                                        ...
                                        <tr>
                                            <td width="100%" class="blk_container bmeHolder bmeBody" name="bmeBody" valign="top" align="center" style="color: rgb(56, 56, 56); border: 0px none transparent; background-color: rgb(212, 0, 1);" bgcolor="#a02b63">
                                                ...
                                                <div id="dv_15" class="blk_wrapper">
                                                    <table width="600" cellspacing="0" cellpadding="0" border="0" class="blk" name="blk_card">
                                                        <tbody>
                                                        <tr>
                                                            <td class="bmeImageCard" align="center" style="padding-left:0px; padding-right:0px; padding-top:10px; padding-bottom:10px;">
                                                                <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                                    <tbody>
                                                                    <tr>
                                                                        <td valign="top" class="bmeImageContainer" style="border-collapse: collapse; background-color: rgb(255, 255, 255);" width="600">
                                                ...
                                                <div id="dv_22" class="blk_wrapper">
                                                    ...
                                                    <table width="600" cellspacing="0" cellpadding="0" border="0" class="blk" name="blk_imagecaption" style="background-color: rgb(212, 0, 1);"><tbody><tr><td>
                                                                <table cellspacing="0" cellpadding="0" class="bmeCaptionContainer" width="100%" style="padding-left:20px; padding-right:20px; padding-top:20px; padding-bottom:20px;border-collapse:separate;"><tbody><tr><td class="bmeImageContainerRow" valign="top" gutter="10">
                                                                            <table width="100%" cellpadding="0" cellspacing="0" border="0"><tbody><tr><td class="tdPart" valign="top">
                                                                                        <table cellspacing="0" cellpadding="0" border="0" class="bmeImageContainer" width="560" align="left" style="float:left;"><tbody><tr><td valign="top" name="tdContainer">
                                                                                                    ...
                                                                                                    <table cellspacing="0" cellpadding="0" border="0" class="bmeCaptionTable" width="560" style="padding-top:20px; border-collapse:separate;"><tbody><tr><td name="tblCell" valign="top" align="left" style="font-family: Arial,Helvetica,sans-serif; font-size: 14px; font-weight: normal; color: #383838; text-align: left;" class="tblCell"><div style="line-height: 150%; text-align: center;"><span style="font-size: 14px; font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Helvetica, Arial, sans-serif; color: #ffffff; line-height: 150%;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi et mauris sed mauris tincidunt consectetur sed luctus libero. Donec pellentesque vitae tellus nec gravida. In sit amet sapien pulvinar velit varius cursus. Aenean elit diam, tincidunt vestibulum scelerisque sed, congue sed lectus. Fusce orci felis, efficitur sed massa in, porta pulvinar eros. Vestibulum a felis orci. Mauris dictu</span></div></td></tr></tbody>
                                                                                                    </table></td></tr></tbody>
                                                                                        </table></td></tr></tbody>
                                                                            </table></td></tr></tbody>
                                                                </table></td></tr></tbody>
                                                    </table></div><div id="dv_23" class="blk_wrapper">
                                                    <table width="600" cellspacing="0" cellpadding="0" border="0" class="blk" name="blk_social_follow" style="background-color: rgb(212, 0, 1);"><tbody><tr><td class="tblCellMain" align="center" style="padding: 10px 20px;">
                                                    ...
                                                    <table width="600" cellspacing="0" cellpadding="0" border="0" class="blk" name="blk_divider" style="background-color: rgb(212, 0, 1);"><tbody><tr><td class="tblCellMain" style="padding: 10px 20px;">
