       ...
       @csrf
          <div class="row g-3">
            <div class="col-sm-12">
              ...
              <input type="text" class="form-control" id="nome_produto" name="nome_produto" placeholder="" value="{{$produto->nome_produto}}" required>
           ...
           <div class="col-12">
              ...
              <div class="input-group has-validation">
                ...
                <input type="text" class="form-control" id="custo_produto" name="custo_produto" placeholder="9,99" value="{{$produto->custo_produto}}" required>
              <div class="invalid-feedback">
            ...
            <div class="col-12">
              ...
              <div class="input-group has-validation">
                <span class="input-group-text">R$</span>
                <input type="text" class="form-control" id="valor_produto" name="valor_produto" placeholder="9,99" value="{{$produto->valor_produto}}" required>
              <div class="invalid-feedback">
            ...
            <div class="col-12">
              ...
              <input type="text" class="form-control" id="quantidade_produto" name="quantidade_produto" placeholder="" value="{{$produto->quantidade_estoque}}" required>
              <div class="invalid-feedback">
