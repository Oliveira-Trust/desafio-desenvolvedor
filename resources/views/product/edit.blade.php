                        ...
                        @csrf
                            ...
                            <div class="form-group mt-3">
                                <div class="col-sm-4 offset-sm-8 text-md-right">
                                    <button type="button" id="btnUpdateProduct" class="btn btn-sm btn-outline-primary">
                            ...
                            <input type="hidden" name="hdnProductId" id="hdnProductId" value="{{ $product_id }}" />
                    </form>
                </div>
            </div>
        </div>
...
<script src="{{ asset('js/product/edit.js') }}" type="text/javascript"></script>
<script>
    ProductEdit.init();
</script>
@endsection
