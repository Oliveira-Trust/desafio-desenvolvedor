                ...
                <x-slot name="form">
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        <form id="myForm" name="myForm">
                            ...
                            <select id="currency_from" class="mt-1 block w-full" name="currency_from"
                                wire:model.defer="state.currency_from" autofocus>
                                <option value="BRL" selected> BRL </option>
                            </select>

                            <x-jet-label for="ticket" value="{{ __('Taxa para Boleto (%)') }}" />
                            <x-jet-input id="ticket" type="number" step=".01" class="mt-1 block w-full"
                                wire:model.defer="state.ticket" autofocus />

                            <x-jet-label for="card" value="{{ __('Taxa para Cartão de crédito (%)') }}" />
                            <x-jet-input id="card" type="number" step=".01" class="mt-1 block w-full"
                                wire:model.defer="state.card" autofocus />
