                        ...
                        @csrf
                            ...
                            <div class="form-group mt-3">
                                <div class="col-sm-4 offset-sm-8 text-md-right">
                                    <button type="button" id="btnUpdateOrder" class="btn btn-sm btn-outline-primary">
                                        <i class="material-icons vertical-align-middle">done_all</i> Atualizar
                                    </button>
                            ...
                            <input type="hidden" name="hdnOrderId" id="hdnOrderId" value="{{ $order_id }}" />
                    </form>
                </div>
            </div>
        </div>
...
<script src="{{ asset('js/order/edit.js') }}" type="text/javascript"></script>
<script>
    OrderEdit.init();
</script>
@endsection
