<div class="form-group {{ $errors->has('produto_nome') ? 'has-error' : ''}}">
    ...
    <textarea class="form-control" rows="5" name="produto_nome" type="textarea" id="produto_nome" >{{ isset($produto->produto_nome) ? $produto->produto_nome : ''}}</textarea>
...
<div class="form-group {{ $errors->has('produto_forn') ? 'has-error' : ''}}">
    ...
    <textarea class="form-control" rows="5" name="produto_forn" type="textarea" id="produto_forn" >{{ isset($produto->produto_forn) ? $produto->produto_forn : ''}}</textarea>
...
<div class="form-group {{ $errors->has('produto_cont') ? 'has-error' : ''}}">
    ...
    <textarea class="form-control" rows="5" name="produto_cont" type="textarea" id="produto_cont" >{{ isset($produto->produto_cont) ? $produto->produto_cont : ''}}</textarea>
