...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('currency_purchases', function (Blueprint $table) {
            ...
            $table->float('destination_currency_price', 8, 2);
            $table->float('convertion_fee', 5, 2)->nullable();
            $table->float('convertion_fee_value', 8, 2)->nullable();
            $table->float('payment_fee', 5, 2)->nullable();
            $table->float('converted_currency_value', 8, 2);
            $table->float('payment_fee_value', 8, 2)->nullable();
