 ...
 */
class ByDateCriteria extends AbstractCriteria
{
    /**
     * @var null
     */
     ...
     * @param null $table
     */
    public function __construct($field = null, $value = null, $operator = '=', $table = null)
    {
        $this->field = $field;
        $this->value = $value;
        $this->table = $table;
    ...
    public function applyToQuery($model)
    {
        ...
        $query = $model->whereDate($field, $this->operator, $this->value);
