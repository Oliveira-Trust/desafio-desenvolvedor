 ...
 */
class LeftJoinCriteria extends AbstractCriteria
{
    /**
     * @var null
     */
    ...
    public function applyToQuery($model)
    {
        ...
        $table = !$this->localTable ? with(new $m)->getTable() : $this->localTable;

        $query = $model->leftJoin($this->linkTable, function ($join) use ($table) {
