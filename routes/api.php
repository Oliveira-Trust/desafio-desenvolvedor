...
Route::post('v1/sanctum/token', [App\Http\Controllers\Auth\LoginController::class, 'login']);
Route::middleware('auth:sanctum')->group(function () {
    Route::post('v1/sanctum/logout', [App\Http\Controllers\Auth\LoginController::class, 'logout']);
