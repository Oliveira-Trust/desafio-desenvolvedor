...
Route::middleware(['auth:sanctum', 'verified'])->post('/loja/adicionar-quantidade-produto', [PedidoController::class, 'adicionarQuantidadeProduto'])->name('adicionar_quantidade_produto');
Route::middleware(['auth:sanctum', 'verified'])->post('/loja/subtrair-quantidade-produto', [PedidoController::class, 'subtrairQuantidadeProduto'])->name('subtrair_quantidade_produto');
