                    ...
                    <div class="row">
                       ...
                       <div class="col-lg-3-5 col-xl-4-5">
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-lg-7 col-xl-6">
                                    <input type="text" class="form-control form-control-modern" name="desperson" style="background-color: rgb(240, 240, 240);"  value="<?php echo htmlspecialchars( $user["desperson"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" required />
                                </div>
                            </div> 
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-lg-7 col-xl-6">
                                    <input id="fc_inputmask_1" data-plugin-masked-input data-input-mask="999.999.999-99" name="desdocument" placeholder="___.___.___-__" class="form-control form-control-modern" value="<?php echo htmlspecialchars( $user["desdocument"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" style="background-color: rgb(240, 240, 240);" required >
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-lg-7 col-xl-6">
                                    <input id="date" data-plugin-masked-input data-input-mask="99/99/9999" name="desdtbirth" placeholder="__/__/____" class="form-control form-control-modern" style="background-color: rgb(240, 240, 240);"  value="<?php echo htmlspecialchars( $FormatedDate, ENT_COMPAT, 'UTF-8', FALSE ); ?>" required>
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-lg-7 col-xl-6">                                                                    
                                    <input id="phone" data-plugin-masked-input data-input-mask="(99) 999999999" placeholder="(00) 123456789" name="desphonenumber"  class="form-control form-control-modern" value="(<?php echo htmlspecialchars( $user["nrddd"], ENT_COMPAT, 'UTF-8', FALSE ); ?>)<?php echo htmlspecialchars( $user["nrphone"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" required style="background-color: rgb(240, 240, 240);">
                    ...
                    <div class="col-lg-3-5 col-xl-4-5">
                        ...
                        <div class="form-group row align-items-center">
                            ...
                            <div class="col-lg-7 col-xl-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control form-control-modern" name="desaddress"  id="endereco" value="<?php echo htmlspecialchars( $UserAddress["desaddress"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" required style="background-color: rgb(240, 240, 240);" />
                        ...
                        <div class="form-group row align-items-center">
                            ...
                            <div class="col-lg-7 col-xl-6">
                                ...
                                <div class="input-group">
                                  ...
                                  <input type="text" class="form-control form-control-modern" name="descity"  value="<?php echo htmlspecialchars( $UserAddress["descity"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" id="cidade"  required style="background-color: rgb(240, 240, 240);" />
                        ...
                        <div class="form-group row align-items-center">
                            ...
                            <div class="col-lg-7 col-xl-6">
                                ...
                                <div class="input-group">
                                   ...
                                   <input type="text" class="form-control form-control-modern" name="desstreet"  value="<?php echo htmlspecialchars( $UserAddress["desdistrict"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" id="bairro" required style="background-color: rgb(240, 240, 240);" />
                                </div>
                        ...
                        <div class="form-group row align-items-center">
                            ...
                            <div class="col-lg-7 col-xl-6">
                                ...
                                <input type="text" class="form-control form-control-modern" name="deshousenumber" value="<?php echo htmlspecialchars( $UserAddress["desnumber"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"  required style="background-color: rgb(240, 240, 240);" />
                            </div>  
                         </div>                                
                        </div>
                        ...
                        <div class="form-group row align-items-center">
                            ...
                            <div class="col-lg-7 col-xl-6">
                                ...
                                <input type="text" class="form-control form-control-modern" name="desaddresextra" value="<?php echo htmlspecialchars( $UserAddress["descomplement"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"   required style="background-color: rgb(240, 240, 240);" />
                            </div>       
                         </div>                                
                        </div>
