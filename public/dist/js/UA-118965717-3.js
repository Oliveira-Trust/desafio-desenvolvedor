...
(function () {
  ...
  */
  ...
  var oa = fa,
    ...
    if (oa) oa(a, b);else for (var c in b) {
  ...
  var Ba = function Ba() {},
    ...
    return -1;
      ...
      Ha = function Ha(a, b) {
    if (a && Fa(a)) for (var c = 0; c < a.length; c++) {
    ...
    return "false" == String(a).toLowerCase() ? !1 : !!a;
      ...
      Ta = function Ta(a) {
    var b = [];
    if (Fa(a)) for (var c = 0; c < a.length; c++) {
      b.push(String(a[c]));
    }
    return b;
  },
  ...
  var ib = /\[object (Boolean|Number|String|Function|Array|Date|RegExp)\]/,
    ...
    for (d in a) {
      if (kb(a, d)) {
        var e = a[d];
        "array" == jb(e) ? ("array" != jb(c[d]) && (c[d] = []), c[d] = m(e, c[d])) : mb(e) ? (mb(c[d]) || (c[d] = {}), c[d] = m(e, c[d])) : c[d] = e;
      }
    }
  ...
  var qb = function qb(a) {
    if (void 0 === a || Fa(a) || mb(a)) return !0;
  ...
  var Sb = [],
    ...
    for (f in a) {
      if (a.hasOwnProperty(f)) if (0 === f.indexOf("vtp_")) d && b && b.Se && b.Se(a[f]), e[void 0 !== d ? f : f.substr(4)] = a[f];else if (f === rb.Af.toString() && a[f]) {}
    }
    ...
    if (Fa(a)) {
      ...
      switch (a[0]) {
        ...
        case "escape":
          d = bc(a[1], b, c);
          if (Zb && Fa(a[1]) && "macro" === a[1][0] && Zb.dh(a)) return Zb.rh(d);
          d = String(d);
  ...
  var Hc = {};
  C.xf = (Hc[C.fa] = !0, Hc[C.Nc] = !0, Hc[C.ae] = !0, Hc[C.be] = !0, Hc[C.ce] = !0, Hc[C.de] = !0, Hc[C.ee] = !0, Hc[C.V] = !0, Hc[C.fe] = !0, Hc[C.qb] = !0, Hc[C.rb] = !0, Hc[C.W] = !0, Hc[C.ia] = !0, Hc[C.qa] = !0, Hc[C.aa] = !0, Hc[C.ja] = !0, Hc[C.ie] = !0, Hc[C.ke] = !0, Hc[C.qe] = !0, Hc[C.se] = !0, Hc[C.Sc] = !0, Hc[C.Yb] = !0, Hc[C.Za] = !0, Hc[C.te] = !0, Hc[C.ub] = !0, Hc[C.Ca] = !0, Hc[C.ue] = !0, Hc[C.ve] = !0, Hc[C.we] = !0, Hc[C.xe] = !0, Hc[C.Yc] = !0, Hc[C.vb] = !0, Hc[C.Ma] = !0, Hc[C.ad] = !0, Hc[C.xb] = !0, Hc[C.Da] = !0, Hc[C.cc] = !0, Hc[C.Ea] = !0, Hc[C.bd] = !0, Hc[C.yb] = !0, Hc[C.Fa] = !0, Hc);
  ...
  var Kd = [C.B, C.J],
    ...
    for (var d = Fa(b) ? b : [b], e = 0; e < d.length; ++e) {
      for (var f in a) {
        if (a.hasOwnProperty(f) && f !== C.Pd && f !== C.Qd) if (-1 < Ga(Kd, f)) {
          var h = f,
              k = a[f],
              l = d[e];
          vd().set(h, k, l, "BR", "BR-MG", c);
        } else {}
      }
    }
  },
      Md = function Md(a, b) {
    for (var c in a) {
      if (a.hasOwnProperty(c)) if (-1 < Ga(Kd, c)) {
        var d = c,
            e = a[c];
        vd().update(d, e);
      } else {}
  ...
  He.kc = "3a0";
  He.Gh = "";
  He.Cf = "ChAI8N3bggYQt4eTgMiboukjEicADH5zNT+yTRGbTFwxuSIKWusP6ceZP7OXrXtG5H0/ZPFMEvvKwgwaAsV6";
  var Je = {
    __cl: !0,
    __ecl: !0,
    __ehl: !0,
  ...
  var Ve = {},
    ...
    return d;
      ...
      cf = function cf(a, b) {
    Ye.hasOwnProperty(a) || (We.set(a, b), m(gb(a, b), Xe), Ze());
  },
      Ze = function Ze(a) {
    Ma(Ye, function (b, c) {
      We.set(b, c);
  ...
  var lf = function lf(a) {
    var b = 1,
        ...
        d,
        e;
    if (a) for (b = 0, d = a.length - 1; 0 <= d; d--) {
    ...
    if ("auto" === l) {
      for (var n = xf(), q = 0; q < n.length; ++q) {
        var p = "none" !== n[q] ? n[q] : void 0,
            r = d(f, "domain", p);
        r = e(r, c.flags);
        if (!yf(p, c.path) && vf(r, a, b, c.xa)) return 0;
      }
    ...
    for (var d = Yf().decorators, e = {}, f = 0; f < d.length; ++f) {
      ...
      if (k = !c || h.forms) a: {
        var l = h.domains,
            n = a,
            q = !!h.sameHost;
        if (l && (q || n !== H.location.hostname)) for (var p = 0; p < l.length; p++) {
  ...
  function vg() {
    ...
    for (var c = 0; c < a.length; c++) {
      ...
      "1" == d[0] && 3 === d.length && d[1] && (b[a[c].Ld] || (b[a[c].Ld] = []), b[a[c].Ld].push({
        timestamp: d[1],
        Ia: d[2]
      }));
    }
  ...
  var Zg = function Zg(a) {
    ...
    Wg(function () {
      ...
      var l = Kf[Lf(b.prefix)],
          n = !1;
      if (l && 0 < e.length) for (var q = L.joined_auid = L.joined_auid || {}, p = 0; p < e.length; p++) {
        var r = e[p],
            u = r.Ia,
            t = r.bf,
            v = (b.prefix || "_gcl") + "." + t + "." + u;
  ...
  var kh = function kh(a, b, c) {
    if (G[a.functionName]) return b.Ad && I(b.Ad), G[a.functionName];
    var d = jh();
    G[a.functionName] = d;
    if (a.nc) for (var e = 0; e < a.nc.length; e++) {
      ...
      if (!d || e) {
        ...
        if (l) {
          ...
          for (var x = 0; x < n.length; x++) {
            if (x < v) if (d) rh(d, n[x], u, {
              va: t,
              options: r
            });else if ("AW" === a.prefix && a.F[1]) sh() ? rh([a], n[x], u || "US", {
              va: t,
              options: r
            }) : qh(a.F[0], a.F[1], n[x], {
              va: t,
              options: r
            });else if ("UA" === a.prefix) if (sh()) rh([a], n[x], u || "US", {
              va: t
            });else {
              var A = a.containerId,
                  w = n[x],
  ...
  var Dh = function Dh() {
    ...
    d ? D(8) : d = [];
    Eh() && (d = Ta(d), d.push("nonGooglePixels", "nonGoogleScripts", "sandboxedScripts"));
    ...
    return function (h) {
      ...
      if (b) {
        var q;
        if (q = n) a: {
          if (0 > Ga(c, k)) if (l && 0 < l.length) for (var p = 0; p < l.length; p++) {
            if (0 > Ga(c, l[p])) {
              D(11);
              q = !1;
              break a;
  ...
  function Th() {
    if (!Lh && 140 > Mh) {
      ...
      try {
        H.documentElement.doScroll("left"), Sh();
      } catch (a) {
        G.setTimeout(Th, 50);
      }
    }
  ...
  var ii = function ii(a) {
    ...
    if (G[b]) G.hasOwnProperty(b) || D(12);else {
      var c = function c() {
        c.q = c.q || [];
        c.q.push(arguments);
      };
  ...
  var si = function si() {
    ...
    wi || (wi = G.setTimeout(ui, 500));
      ...
      ui = function ui() {
    wi && (G.clearTimeout(wi), wi = void 0);
    void 0 === yi || zi[yi] && !Ai && !Bi || (Ci[yi] || Di.eh() || 0 >= Ei-- ? (D(1), Ci[yi] = !0) : (Di.vh(), jd(ti()), zi[yi] = !0, Fi = Gi = Hi = Bi = Ai = ""));
  },
      ti = function ti() {
    var a = yi;
    if (void 0 === a) return "";
  ...
  var Zi = !1,
    ...
    Li && !Ci[b] && yi !== b && (ui(), yi = b, Fi = Ai = "", Ji[b] = "&e=" + (0 === c.indexOf("gtm.") ? encodeURIComponent(c) : "*") + "&eid=" + b, xi());
  ...
  function cj(a, b) {
    ...
    for (var c = 0; c < a.length; c++) {
      if (a[c] && Vb[c] && !Ke[String(Vb[c][rb.Na])]) return !0;
    }
  ...
  Cj.prototype.addEventListener = function (a) {
    ...
    var e = function e(f, h) {
      clearTimeout(d);
      f ? (b = f, b.internalErrorState = Bj(b), h && 0 === b.internalErrorState || (b.tcString = "tcunavailable", h || (b.internalErrorState = 3))) : (b.tcString = "tcunavailable", b.internalErrorState = 3);
      a(b);
    };
  ...
  var Hj = function Hj(a, b, c) {
    ...
    } else l = 1 === k ? a.purpose && a.vendor ? Gj(a.purpose.legitimateInterests, b) && Gj(a.vendor.legitimateInterests, void 0 === d ? "755" : d) : !0 : !0;
    return l;
  },
      Gj = function Gj(a, b) {
    return !(!a || !a[b]);
    ...
    if ((Sj() ? !0 === G.gtag_enable_tcf_support : !1 !== G.gtag_enable_tcf_support) && !a.active && ("function" === typeof G.__tcfapi || Ej(b))) {
      ...
      try {
        b.addEventListener(function (e) {
          ...
          if (0 !== e.internalErrorState) Uj(a), Vj(a), Qj(c);else {
            var f;
            a.gdprApplies = e.gdprApplies;
            if (!1 === e.gdprApplies) f = Wj(), b.removeEventListener(e);else if ("tcloaded" === e.eventStatus || "useractioncomplete" === e.eventStatus || "cmpuishown" === e.eventStatus) {
              var h = {},
                  k;

              for (k in Kj) {
                if (Kj.hasOwnProperty(k)) if ("1" === k) {
                  var l,
                      n = e,
                      q = !0;
                  q = void 0 === q ? !1 : q;
                  var p;
                  var r = n;
                  !1 === r.gdprApplies ? p = !0 : (void 0 === r.internalErrorState && (r.internalErrorState = Bj(r)), p = "error" === r.cmpStatus || 0 !== r.internalErrorState || "loaded" === r.cmpStatus && ("tcloaded" === r.eventStatus || "useractioncomplete" === r.eventStatus) ? !0 : !1);
        ...
        d && (clearTimeout(d), d = null), Uj(a), Vj(a);
      }
    }
  };
  ...
  function Tj() {
    var a = {};
    Ld((a.ad_storage = "denied", a.wait_for_update = Mj, a));
  }
  ...
  function Vj(a) {
    var b = {};
    Md((b.ad_storage = a.Ob["1"] ? "granted" : "denied", b));
  }
  ...
  var Yj = function Yj() {
    ...
    return a.active && void 0 !== a.gdprApplies ? a.gdprApplies ? "1" : "0" : "";
      ...
      bk = function bk(a) {
    if (!Kj.hasOwnProperty(String(a))) return !0;
    var b = Oj();
    ...
    function b(t) {
      ...
      if (!v[x]) {
        ...
        var A = [],
            w = {},
            y = function y(N, P) {
          P && (A.push(N + "=" + encodeURIComponent(P)), w[N] = !0);
        },
        ...
        y("gdpr_consent", Zj()), y("gdpr", ak());
        "1" === kg(!1)._up && y("gtm_up", "1");
        y("gclid", fk(d, l));
        y("gclsrc", n);
        y("gtm", vj(!e));
        ck && h && Nd(C.B) && (Pf(f || {}), y("auid", Kf[Lf(f.prefix)] || ""));
  ...
  var gk = function gk(a) {
    ...
    if (c || 1 === xh()) d = "https://www.google.com";
    ...
    function h(ja) {
      ...
      u && (Y("delopc", t(C.ad)), Y("oedeld", t(C.se)), Y("delc", t(C.he)), Y("shf", t(C.oe)), Y("iedeld", yh(t(C.V))));
      Aa && ik.push(Q);
    }
    ...
    if (b === C.oa) {
      ...
      if (!q || !u && !la) if (!0 === t(C.be) && (u = !1), !1 !== t(C.fa) || u) {
        var Q = {
        ...
        var Y = function Y(ja, Aa) {
          void 0 != Aa && "" !== Aa && (Q.google_additional_conversion_params = Q.google_additional_conversion_params || {}, Q.google_additional_conversion_params[ja] = Aa);
        },
            Da = function Da(ja, Aa) {
          void 0 != Aa && "" !== Aa && (Q.google_additional_params = Q.google_additional_params || {}, Q.google_additional_params[ja] = Aa);
        };

        "1" === kg(!1)._up && Y("gtm_up", "1");
        u && (Y("vdnc", t(C.te)), Y("vdltv", t(C.ie)));
        e();
        var lb = xh();
  ...
  var pk = function pk(a) {
    return !(void 0 === a || null === a || 0 === (a + "").length);
      ...
      qk = function qk(a, b) {
    var c;
    if (2 === b.ca) return a("ord", Ia(1E11, 1E13)), !0;
    if (3 === b.ca) return a("ord", "1"), a("num", Ia(1E11, 1E13)), !0;
    if (4 === b.ca) return pk(b.sessionId) && a("ord", b.sessionId), !0;
    if (5 === b.ca) c = "1";else if (6 === b.ca) c = b.Gd;else return !1;
    pk(c) && a("qty", c);
    pk(b.sc) && a("cost", b.sc);
    pk(b.transactionId) && a("ord", b.transactionId);
    return !0;
  },
      sk = function sk(a, b, c) {
    function d(z, B, E) {
      r.hasOwnProperty(z) || (B = String(B), p.push(";" + z + "=" + (E ? B : rk(B))));
    }
    ...
    var n = ";",
        q = !1;
    q = !0;
    Nd(C.B) || l || !a.la && !q || (k = "https://ade.googlesyndication.com/ddm/activity", n = "/", h = !1);
  ...
  var uk = function uk(a, b, c, d) {
    function e() {
      ...
      c && (Pf(d), f.auiddc = Kf[Lf(d.prefix)]);
      b && (f.loadInsecure = b);
    ...
    var c = encodeURIComponent,
        d = [],
        e = a(C.V) || [];
    if (Fa(e)) for (var f = 0; f < e.length; f++) {
      var h = e[f],
          k = f + 1;
      b("i", k, h.id);
      b("p", k, h.price);
      ...
      if (b === C.oa) {
        ...
        var w = {
          ...
          flags: q
            ...
            z = f(C.sb),
            B = void 0 === z ? !0 : !!z;
        h && (sg(y[C.$a], !!y[C.I]) && Og(yk, w), Mg(w), Rg(yk, w), zk ? $g(B, w) : ah(B, w));
        y[C.I] && Qg(yk, y[C.I], y[C.cb], !!y[C.ab], k);
        f(C.Ea) && Tg();
        if (p && p.exclusion_parameters && p.engines) if (gh()) {} else uk(p, u, h, w);
        ek({
          nd: !0,
          la: r,
          R: a,
  ...
  var Ck = function Ck(a) {
    function b() {
      ...
      if (a.conversionLinkerEnabled) {
        ...
        if (h && h.length) for (var k = 0; k < h.length; k++) {
          f += "&gclgf=" + Bk(h[k]);
        }
      }
  ...
  var Dk = /.*\.google\.com(:\d+)?\/(?:booking|travel)\/flights.*/,
    ...
    if (b === C.oa) {
      ...
      if (b === C.za) {
        ...
        w.price = z;
        Ck(w);
      } else if (b !== C.na) I(d.onFailure);else {
        var B = {
          partner_id: h,
          trip_type: e(C.jg),
          total_price: e(C.Fa),
          ...
          flight_segment: Ek(e(C.V))
            ...
            E = e(C.bg);
        E && "object" === typeof E && (B.passengers_total = Oa(E.total), B.passengers_adult = Oa(E.adult), B.passengers_child = Oa(E.child), B.passengers_infant_in_seat = Oa(E.infant_in_seat), B.passengers_infant_in_lap = Oa(E.infant_in_lap));
        w.conversion_data = B;
        Ck(w);
      }
    }
  ...
  var Tk = function Tk(a, b) {
    ...
    if (Ca(e)) {
      var f = "gtag_" + a.split("-").join("_"),
        ...
        if (y) {
          var z = y.action;
          if ("impressions" === z) w("ec:addImpression", y.$g);else if ("promo_click" === z || "promo_view" === z) {
            var B = y.Fd;
            w("ec:addPromo", y.Fd);
            B && 0 < B.length && "promo_click" === z && h("ec:setAction", z);
          } else w("ec:addProduct", y.ib), h("ec:setAction", z, y.Db);
        }
      },
          l = function l() {
        if (gh()) {} else {
      ...
      if (n.Ga._x_19) {
        ...
        p && (d = p);
        n.Ga._x_20 && !Yk[f] && (Yk[f] = !0, e(ni(f, n.Ga._x_20)));
      }
      ...
      b === C.Mc ? (l(), h("send", "pageview", n.Ha)) : b === C.Z ? (l(), th(a, c), c.getWithConfig(C.Ea) && (Tg(), ki(f + ".")), 0 != n.sendPageView && h("send", "pageview", n.Ha), Wk(a, f, c)) : b === C.oa ? Tk(f, c) : "screen_view" === b ? h("send", "screenview", n.Ha) : "timing_complete" === b ? (q("timingCategory", n.eventCategory, !0), q("timingVar", n.name, !0), q("timingValue", Oa(n.value)), void 0 !== n.eventLabel && q("timingLabel", n.eventLabel, !0), h("send", "timing", n.Ha)) : "exception" === b ? h("send", "exception", n.Ha) : "optimize.callback" !== b && (0 <= Ga([C.Ub, "select_content", C.za, C.Va, C.Wa, C.Ka, "set_checkout_option", C.na, C.Xa, "view_promotion", "checkout_progress"], b) && (h("require", "ec", "ec.js"), k()), q("eventCategory", n.eventCategory, !0), q("eventAction", n.eventAction || b, !0), void 0 !== n.eventLabel && q("eventLabel", n.eventLabel, !0), void 0 !== n.value && q("eventValue", Oa(n.value)), h("send", "event", n.Ha));
      var t = !1;
      var v = bl;
    ...
    if (void 0 !== c) if (gl[b] && (c = Qa(c)), "anonymize_ip" !== b || c || (c = void 0), 1 === a) d[Sk(b)] = c;else if (g(a)) d[a] = c;else for (var e in a) {
    ...
    for (var u = rj(d), t = 0; t < u.length; ++t) {
      var v = u[t],
          x = f(v);
      if (fl.hasOwnProperty(v)) al(fl[v], v, x, h);else if (Rk.hasOwnProperty(v)) al(Rk[v], v, x, k);else if (Qk.hasOwnProperty(v)) al(Qk[v], v, x, l);else if (/^(dimension|metric|content_group)\d+$/.test(v)) al(1, v, x, k);else if ("developer_id" === v) {
        var A = hb(x);
        A && (k["&did"] = A);
      } else v === C.aa && 0 > Ga(u, C.Wb) && (l.cookieName = x + "_ga");
    }
    ...
    var n = f("custom_map");
    if (mb(n)) for (var q = 0; h && q < h.length; ++q) {
      var p = h[q],
          r;
  ...
  aa.flush = function (a) {
    for (var b = this, c = [], d = !1, e = {}; this.m.length;) {
      var f = this.m[0];
      if (f.o) kl ? !f.R || ul(this, f.R).m ? (f.o = !1, this.m.push(f)) : c.push(f) : (f.o = !1, this.m.push(f));else switch (f.type) {
        case "require":
  ...
  var Cl = !!G.MutationObserver,
    ...
    if (!Dl) {
      var b = function b() {
        var c = H.body;
        if (c) if (Cl) new MutationObserver(function () {
  ...
  function Ol(a, b) {
    ...
    b && (c.eventModel = m(b), b[C.Qc] && (c.eventCallback = b[C.Qc]), b[C.Xb] && (c.eventTimeout = b[C.Xb]));
    return c;
  }

  function Pl() {
    Ll = Ll || !L.gtagRegistered, L.gtagRegistered = !0, Ll && (L.addTargetToGroup = function (a) {
      Ql(a, "default");
    });
    return Ll;
  }
  ...
  var Sl = {
    ...
    event: function event(a) {
      ...
      if (!(2 > a.length) && g(b)) {
        ...
        var e;
        var f = c && c[C.Ma];
        void 0 === f && (f = $e(C.Ma, 2), void 0 === f && (f = "default"));
    ...
    get: function get(a) {
      D(53);
      if (4 !== a.length || !g(a[1]) || !g(a[2]) || !Ca(a[3])) return;
      var b = dh(a[1]),
          c = String(a[2]),
          d = a[3];
      if (!b) return;
      Nl || D(43);
      if (!Pl() || -1 === Ga(Kl, b.prefix)) return;
      Ue();
      var e = {};
      Jh(m((e[C.Ba] = c, e[C.Aa] = d, e)));
      ql(c, function (f) {
        I(function () {
          return d(f);
        });
    ...
    js: function js(a) {
      if (2 == a.length && a[1].getTime) return Nl = !0, Pl(), {
        event: "gtm.js",
    ...
    set: function set(a) {
      var b;
      2 == a.length && mb(a[1]) ? b = m(a[1]) : 3 == a.length && g(a[1]) && (b = {}, mb(a[2]) || Fa(a[2]) ? b[a[1]] = m(a[2]) : b[a[1]] = a[2]);
  ...
  function xm() {
    for (var a = !1; !sm && 0 < pm.length;) {
      ...
      if (d && !qm && wm()) {
        var e = {};
        pm.unshift((e.event = "gtm.init_consent", e));
        qm = !0;
      }
  ...
  var Am = function Am() {
    ...
    a.push = function () {
      ...
      var h = c.apply(a, e);
      pm.push.apply(pm, e);
      if (300 < this.length) for (D(4); 300 < this.length;) {
        this.shift();
      }
  ...
  Bm.nh = function (a, b, c) {
    a instanceof Bm.xg && (a = a.m(Bm.wh(b, c)), b = Ba);
    return {
      Zg: a,
      onSuccess: b
    };
  ...
  var Tm = G.clearTimeout,
    ...
    return $e(a, b || 2);
      ...
      $m = function $m(a, b, c) {
    var d;
    b ? (a.eventCallback = b, c && (a.eventTimeout = c), d = tm(a)) : d = tm(a);
    return d;
  },
      an = function an(a, b) {
    G[a] = b;
  ...
  var yq = {};
  yq.macro = function (a) {
    if (Bm.hd.hasOwnProperty(a)) return Bm.hd[a];
  }, yq.onHtmlSuccess = Bm.Ve(!0), yq.onHtmlFailure = Bm.Ve(!1);
  yq.dataLayer = af;
  ...
  function Aq() {
    ...
    if (L[He.D]) {
      ...
      Lh = !1;
      Mh = 0;
      if ("interactive" == H.readyState && !H.createEventObject || "complete" == H.readyState) Sh();else {
...
//# sourceMappingURL=UA-118965717-3.js.map