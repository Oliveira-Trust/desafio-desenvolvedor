...
(function(window, document, $) {
    ...
    $(window).on('load',function(){
        ...
        $('a[data-action="collapse"]').on('click',function(e){
            ...
            $(this).closest('.card').children('.card-footer').collapse('toggle');
    ...
    $('.btn-click').click(function () {
        $(this).html('<i class="la la-spinner spinner"></i>');
    });

    $('.click-collpase').on( 'click', function () {
        $(this).next('.heading-elements').children("a[data-action='collapse']").trigger('click')
    } );
