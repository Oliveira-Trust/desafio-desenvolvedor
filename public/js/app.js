...
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data('dataCurrenciesPurchases', function () {
  return {
    openModal: false,
    currenciesPurchases: [],
    searchCurrenciesPurchases: function searchCurrenciesPurchases() {
      var _this = this;

      axios.get('/get-currencies-purchases').then(function (response) {
        _this.currenciesPurchases = response.data.data;
      });
    }
  };
});
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data('buyCurrencyForm', function () {
  return {
    formData: {
      origin_currency: 'BRL',
