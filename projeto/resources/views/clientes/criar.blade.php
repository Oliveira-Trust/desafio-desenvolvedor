...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
		...
		<script>
			...
			document.addEventListener('DOMContentLoaded', function() {
				bindSubmitToFunction('criar_cliente', function() {
					submitFormCriarCliente(event, '{{ route("criar_cliente") }}');
				});
    ...
    <body>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-6 offset-lg-3">
					<form id="criar_cliente" method="POST">
						@csrf
						...
						<div class="form-group">
							...
							<input type="text" name="login" class="form-control" id="login" placeholder="Login do cliente" required>
						</div>
						...
						<div class="form-group">
							...
							<input type="text" name="tel" class="form-control" id="tel" placeholder="Telefone do cliente" required>
						</div>
						
						<div class="form-group">
							<label for="email">E-mail</label>
							<input type="email" name="email" class="form-control" id="email" placeholder="E-mail do cliente" required>
						</div>
